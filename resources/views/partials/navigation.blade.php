<div class='navigation js-nav'>
    <div class='navigation__left'>
        <ul class='navigation__social'>
            <li><a href='#'><img src='{{ asset('img/social/fb.png') }}' alt='Moonshine @ Facebook' width='20'></a></li>
            <li><a href='#'><img src='{{ asset('img/social/ig.png') }}' alt='Moonshine @ Instagram' width='20'></a></li>
